...
public class GreeterTests
{
    ...
    {
        // Arrange
        _dateTimeProvider.DateTimeNow.Returns(new DateTime(2022, 1, 1, 8, 0, 0));
    ...
    {
        // Arrange
        _dateTimeProvider.DateTimeNow.Returns(new DateTime(2022, 1, 1, 13, 0, 0));
    ...
    {
        // Arrange
        _dateTimeProvider.DateTimeNow.Returns(new DateTime(2022,1, 1, 20, 0, 0));
